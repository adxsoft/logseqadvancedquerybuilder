...
**Logseq plugin with same functionality now developed.** You can get it [here](https://github.com/adxsoft/docs-logseq-query-builder-plugin) and see it in action [here](https://youtu.be/EA2jLSQ_WMA)
